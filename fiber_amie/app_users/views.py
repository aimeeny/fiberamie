...
def sign_up_request(request):
    ...
    form = NewUserForm()
    return render(request=request, template_name='app_users/index.html', context={'sign_up_form':form})
...
def login_request(request):
    ...
    return render(request=request, template_name='app_users/index.html', context={'login_form':form})
